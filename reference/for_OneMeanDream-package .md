...
- [`oneMeanTTest`](https://kingssibal.github.io/OneMeanDream/reference/oneMeanTTest.html) -
  Perform one-sample t-test with diagnostics

- [`print.oneMeanTTest`](https://kingssibal.github.io/OneMeanDream/reference/print.oneMeanTTest.html) -
